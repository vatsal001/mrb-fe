...
//       setTotalPages(prodRes.data.pagination.pages);
//     } catch {
//       toast.error("Failed to fetch inventory");
//     } finally {
//       setLoading(false);
//     }
//   }, [headers, currentPage, itemsPerPage, searchDebounced]);
//   useEffect(() => {
//     fetchAll();
//   }, [fetchAll]);
...
//             <button
//               onClick={() =>
//                 setBulkSelected(new Set(displayedProducts.map((p) => p.id)))
//               }
//               className="flex items-center gap-2 bg-white/10 hover:bg-white/15 border border-white/15 text-stone-300 hover:text-white font-bold text-sm px-4 py-3 rounded-xl transition-all whitespace-nowrap"
//             >
...
//                             setCurrentPage(1);
//                           }}
//                           className="h-8 px-2 rounded-lg border border-stone-200 bg-white text-stone-700 text-xs font-medium outline-none focus:ring-2 focus:ring-amber-500/30"
//                         >
...
//                           className="w-8 h-8 rounded-lg flex items-center justify-center bg-white border border-stone-200 text-stone-600 hover:bg-stone-100 hover:text-amber-600 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-white transition-all"
//                         >
//                           <ChevronLeft size={14} />
//                         </button>
//                         <button
...
//                                     : "bg-white border border-stone-200 text-stone-600 hover:bg-stone-100 hover:text-amber-600"
//                                 }`}
//                               >
//                                 {page}
//                               </button>
